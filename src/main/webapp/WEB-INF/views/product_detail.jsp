  ...
  <div class="content-wrapper">
	...
	<div class="box">
			...
			<div class="box-body">
				<div class="form-group">
					<label>제품코드</label> <input type="text" name="title"
						class="form-control" value="${product.product_id}" readonly="readonly" />
				</div>

				<div class="form-group">
					<label>제품명<label>
					<textarea name="content" rows="5" readonly="readonly"
						class="form-control">${product.product_name}</textarea>
				</div>
				...
				<div class="form-group">
					<label>가격</label> <input type="text" name="id"
						class="form-control" value="${product.product_price}" readonly="readonly" />
				</div>
			</div>
	...
	$(function(){
		...
		$(".btn-buy").click(function() {
			location.href = "pay?product_id=" + ${product.product_id};
		});
	})
	</script>
		<div>
